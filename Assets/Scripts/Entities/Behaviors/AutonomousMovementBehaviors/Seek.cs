...
public class Seek : AutonomousMovementBehavior {
    ...
    {
        return SeekToPosition(movementComponent.transform.position, movementComponent.SeekTarget.position, movementComponent.maxSpeed, movementComponent.CurrentVelocity);
    }
